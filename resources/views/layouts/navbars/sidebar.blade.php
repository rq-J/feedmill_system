<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white shadow-lg"
    id="sidenav-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('item_daily') ? 'active' : '' }} " href="{{ url('item_daily') }}">
                    ...
                    <span class="nav-link-text ms-1">Daily Item Entries</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('production_data') ? 'active' : '' }} "
                    href="{{ url('production_data') }}">
                    <div
                        class="icon icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center p-2">
                        <svg aria-hidden="true" focusable="false" data-prefix="fa-duotone" data-icon="gears"
                            class="svg-inline--fa fa-gears fa-w-20" role="img" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span class="nav-link-text ms-1">Production Data</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('item') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Item - Formula</span>
                </a>
            </li>
            <li class="nav-item">
