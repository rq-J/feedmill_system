<div class="container">
    <form wire:submit.prevent="create" method="POST">
        ...
        @endphp
        <div class="row mb-3">
            <label for="no" class="col-md-3 col-form-label text-md">{{ __('Description') }}<span
                    class="text-danger">*</span></label>

            <div class="col-md-12">
                <input id="no" type="text" wire:model="no" wire:keyup="valOnly"
                    class="form-control @error('no') is-invalid @enderror" name="no"
                    value="{{ old('no') }}" placeholder="e.g: NO" autocomplete="no" autofocus
                    {!! $upCaseField !!}>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Create New QuaDowntimelity Assurance?</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Are You Sure You Want To Create New Downtime?
                            </div>
