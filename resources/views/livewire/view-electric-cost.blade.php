<div>
    ...
    <form wire:submit.prevent="update({{ $this->latest->id }})" method="POST">
        @php
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-12">
                            <input type="date" wire:model="date_now" value="{{ old('date_now') }}" name="date_now"
                                id="date_now" class="form-control" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-4">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Update Electric Cost?</h5>
                                <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                Are You Sure You Want To Update Electric Cost?
                            </div>
